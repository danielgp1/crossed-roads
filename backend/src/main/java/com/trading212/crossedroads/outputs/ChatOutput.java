...
public class ChatOutput {
    ...
    public ChatOutput(long chat_id, long participant1_id, long participant2_id, String latest_message_content, long latest_message_sender_id , ZonedDateTime latest_message_time) {
